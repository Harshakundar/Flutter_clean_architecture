...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,permalink,startDate,endDate,country,network,status,imageThumbNailPath);
...
/// Create a copy of TvShows
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? permalink = null,Object? startDate = null,Object? endDate = null,Object? country = null,Object? network = null,Object? status = null,Object? imageThumbNailPath = null,}) {
  return _then(_self.copyWith(
...
switch (_that) {
case _TvShows() when $default != null:
return $default(_that.name,_that.permalink,_that.startDate,_that.endDate,_that.country,_that.network,_that.status,_that.imageThumbNailPath);case _:
  return orElse();
...
class _TvShows implements TvShows {
  const _TvShows({@JsonKey(name: 'name') this.name = '', @JsonKey(name: 'permalink') this.permalink = '', @JsonKey(name: 'start_date') this.startDate = '', @JsonKey(name: 'end_date') this.endDate = '', @JsonKey(name: 'country') this.country = '', @JsonKey(name: 'network') this.network = '', @JsonKey(name: 'status') this.status = '', @JsonKey(name: 'image_thumbnail_path') this.imageThumbNailPath = ''});
...
/// Create a copy of TvShows
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? permalink = null,Object? startDate = null,Object? endDate = null,Object? country = null,Object? network = null,Object? status = null,Object? imageThumbNailPath = null,}) {
